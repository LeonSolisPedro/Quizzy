...
const quizzFakeData3 = {
  ...
  userId: 1,
  questions: [
    { id: 1, typeOfQuestion: 2, title: 'Question 1', description: 'How many apples do you eat per day?', visibleAtTable: true, lastEditedAdminId: 999, lastEditedAdmin: {name: "Pedro León"}, answer: {id:345,answer: "42", answerCheckbox: false}, order: 1, reactId: "7f47a620-eaad-46d6-a260-d7fa322c5b24" },
    { id: 2, typeOfQuestion: 1, title: 'Question 2', description: 'Can you describe a little more of yourself?', visibleAtTable: false, lastEditedAdminId: null, lastEditedAdmin: null, answer: {id: 645,answer: "I am passionate about beign my self and thats it", answerCheckbox: false}, order: 2, reactId: "8f47a620-eaad-46d6-a260-d7fa322c5b24" },
    { id: 44, typeOfQuestion: 0, title: 'Question 3', description: 'At what day do you start working?', visibleAtTable: false, lastEditedAdminId: null, lastEditedAdmin: null, answer: {id: 649,answer: "Mondays", answerCheckbox: false, lastEditedAdmin: {name: "Diego Janus"}}, order: 3,  reactId: "9f47a620-eaad-46d6-a260-d7fa322c5b24" },
    { id: 55, typeOfQuestion: 3, title: 'Question 4', description: 'Did you finish task6?', visibleAtTable: true, lastEditedAdminId: null, lastEditedAdmin: null, answer: {id: 333, answer: "", answerCheckbox: true}, order: 4, reactId: "7f47a620-eaad-46d6-a260-d7fa322c5b66" },
  ]
}
const userResponse1 = {
  id: 534,
...
const quizzFakeData4 = {
  ...
  userId: 1,
  questions: [
    { id: 1, typeOfQuestion: 2, title: 'Question 1', description: 'How many apples do you eat per day?', visibleAtTable: true, lastEditedAdminId: 999, lastEditedAdmin: null, answer: {id:345,answer: "42", answerCheckbox: false}, order: 1, reactId: "9f47a620-1aad-46d6-a260-d7fa322c5b24" },
    { id: 2, typeOfQuestion: 1, title: 'Question 2', description: 'Can you describe a little more of yourself?', visibleAtTable: false, lastEditedAdminId: null, lastEditedAdmin: null, answer: {id: 645,nswer: "I am passionate about beign my self and thats it", answerCheckbox: false}, order: 2, reactId: "9f47a620-2aad-46d6-a260-d7fa322c5b24" },
    { id: 44, typeOfQuestion: 0, title: 'Question 3', description: 'At what day do you start working?', visibleAtTable: false, lastEditedAdminId: null, lastEditedAdmin: null, answer: {id: 649,answer: "Mondays", answerCheckbox: false}, order: 3, reactId: "9f47a620-3aad-46d6-a260-d7fa322c5b24" },
    { id: 55, typeOfQuestion: 3, title: 'Question 4', description: 'Did you finish task6?', visibleAtTable: true, lastEditedAdminId: null, lastEditedAdmin: null, answer: {id: 649,answer: "", answerCheckbox: true}, order: 4, reactId: "7f47a620-eaad-46d6-a260-d7fa322c5b88" },
  ]
}
